...
import hero from "../../asset/images/img.jpeg";
  ...
  return (
    <section className="flex flex-col lg:flex-row dark:text-slate-100 items-cente">
      <div className="text my-5">
        <h1 className="text-5xl fi=ont-bold">The Ultimate Trading Solution</h1>
        <p className="text-2xl my-7 px-1 dark:text-slate-300">
        Using Machine Learning to develop novel
         trading solutions which our clients can use to automate their trading startegies.
        </p>
        <Link
          to="/products"
          type="button"
